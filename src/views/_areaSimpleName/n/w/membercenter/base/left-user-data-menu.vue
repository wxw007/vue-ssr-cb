  ...
  export default {
    props: {
      userMenuList: {
        default() {
          return [
            { userTypeId: "1", menuTypeName: "我的资料", url: resolveUrl(this.$store, "/n/w/membercenter/edit") },
            { userTypeId: "2", menuTypeName: "我的头像", url: resolveUrl(this.$store, "/n/w/membercenter/avatar-edit") },
          ];
        }
      }
    },
