...
import recruitAddViewPc from '@/store/modules/web/life/recruitservice/addView.js'
export default {
    storeModule() {
        return { recruitAddViewPc };
    },
    asyncData({ store }) {
        return store.dispatch("recruitAddViewPc/fetchData");
    },
    computed: {
        ...mapState("recruitAddViewPc", ["areaId", "model", "moduleId"])
    },
    components: {
    	publishTabBar,
        indexTemplate,
